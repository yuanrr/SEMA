...
def get_activations(images, model, batch_size=100, dims=2048, cuda=True, verbose=True):
...
def calculate_activation_statistics(images, model, batch_size=48,
...
if __name__ == '__main__':
    ...
    paths = ["",""]
    paths[0] = 'path1'  # the original test dataset
    paths[1] = 'path2'  # synthetic images
    print(paths)
